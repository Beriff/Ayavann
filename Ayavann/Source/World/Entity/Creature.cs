...
class Creature : Entity
{
  ...
  public Creature(BasicEffect effect) : base()
  {
    spriteEffect = effect;
  }
  public void DrawHealthBar(SpriteBatch _spriteBatch, Texture2D texture, Camera camera)
  {
    spriteEffect.World = Matrix.CreateScale(1, -1, 1) * Matrix.CreateTranslation(this.Position + new Vector3(0f, 1.5f, 0f));
    ...
    _spriteBatch.Draw(texture, Vector2.Zero, null, Color.White, 0, new Vector2(texture.Width / 2, texture.Height / 2), 0.005f, 0, 0);
    _spriteBatch.End();
  }
}
